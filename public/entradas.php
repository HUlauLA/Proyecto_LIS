...
$items = Movimiento::listarEntradas((int)$user['id']);
?>
<!doctype html>
<html lang="es"><head>
    ...
    <form method="post" action="/finanzas/public/mov_post.php" enctype="multipart/form-data">
      ...
      <div class="row">
        <div class="col">
          ...
          <input class="input" name="categoria" placeholder="Salario, Venta, etc." required>
        </div>
        <div class="col">
          <label>Monto</label>
      ...
      <input class="input" name="descripcion" placeholder="Detalle de la entrada">
